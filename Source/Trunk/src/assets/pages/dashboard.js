    ...
    var tynguonvonchart = c3.generate({
        ...
        data: {
            ...
            columns: [
                ...
                ['Vốn khác trong nước', 150],
                ['Vốn khác nước ngoài', 140],
                ['Vốn chủ sở hữu', 150]
            ],
            type: 'pie'
        },
    ...
    var chart2 = c3.generate({
        ...
        data: {
            ...
            columns: [
                ...
                ['Vốn khác trong nước',30, 20, 16, 40, 25, 25,30, 20, 16, 40, 25, 20],
                ['Vốn khác nước ngoài', 13, 12, 10, 14, 16, 15,13, 12, 15, 14, 16, 15],
            ...
            groups: [
                ['Vốn đầu tư công','Vốn nhà nước ngoài vốn đầu tư công','Vốn khác trong nước','Vốn khác nước ngoài','Vốn chủ sở hữu']
            ],
