...
[assembly: OwinStartup(typeof(G8.IPM.Web.App_Start.Startup))]

namespace G8.IPM.Web.App_Start
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            app.CreatePerOwinContext(IPMDbContext.Create);
        ...
        {
            var userStore = new UserStore<ApplicationUser>(context.Get<IPMDbContext>());
